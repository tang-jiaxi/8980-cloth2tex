...
def main(category,
    ...
    for idx in range(0,2):
        ...
        ref_img = cv2.imread(f"imgs/{category}/{savedir}/front.jpg".format(category, idx))
        ref_img = cv2.resize(ref_img, (512, 512))
        ref_img_back = cv2.imread(f"imgs/{category}/{savedir}/back.jpg".format(category, idx))
